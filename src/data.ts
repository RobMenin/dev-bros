export const data = [
  {
    ...
    Terrain: "Offroad",
    Description:
      "The KTM 300 XC-W has been at the forefront of the insane pace of development within Extreme Enduro. This nimble, lightweight all-terrain master fears no obstacle, making it the ultimate machine for taking on the renowned Iron Giant. The special ERZBERGRODEO limited edition is packed with KTM PowerParts and a unique graphics kit to commemorate this special event. With everything you need to conquer the world's most extreme enduro race, this unique machine is ready to take you forward in your journey to more extreme enduro.",
  },
  {
    BikeID: 2,
    Make: "Yamaha",
    ...
    Terrain: "Offroad",
    Description:
      "The Yamaha WR450F is an off-road motorcycle made by Yamaha Motor Company. It currently has a 450 cc liquid-cooled single-cylinder engine. The WR in the name indicates a wide-ratio gear box common to most enduro or trail bikes and stands in contrast to the close-ratio gearbox essential to a motocross racer.",
  },
  {
    BikeID: 3,
    Make: "Suzuki",
  ...
  },
  {
    ...
    Terrain: "Road",
    Description:
      "The Honda CBR600F is a CBR series 600 cc four-cylinder sport bike made by Honda. The first model of the CBR600F was sold from 1987 to 1990 and is known in the US as the Hurricane.",
  },
  {
    BikeID: 5,
    Make: "Yamaha",
